...
import (
	...
	"github.com/y-ogura/gae-goa-sample/client"
	"github.com/y-ogura/gae-goa-sample/tool/cli"
	"net/http"
	"os"
	"time"
)
...
func main() {
	...
	app := &cobra.Command{
		Use:   "gae-goa-sample-cli",
		Short: `CLI client for the gae-goa-sample service`,
	}
	...
	c.UserAgent = "gae-goa-sample-cli/0"
